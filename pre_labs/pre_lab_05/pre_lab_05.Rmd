...
**Answer**
1 - changed PHOENIX to Phoenix
2 - changed WESTMINSTER to Westminster
```{r}
...
**Answer**
1 - Changed ABERDEEN to Aberdeen
2 - Changed ABELL to Abell
3 - Changed ABERDEEN Proving Ground to Aberdeen Proving Ground
```{r}
cleaned_md_loans %>%
...
**Answer**
Yes it does, it corrected some spellings and kept some of the same spellings and fixed the capitalizations. 
```{r}
cleaned_md_loans <- md_loans %>%
