...
**Answer**
Yes, they have two chr columns (STNAME and CTYNAME) and 7 dbl columns, SUMLEV, REGION, DIVISION, STATE, COUNTY, YEAR< POPESTIMATE
```{r}
...
**Answer**
Error in join_rows(x_key, y_key, type = type, na_equal = na_equal) :
There's issues with the data types
```{r}
...
### Task 11: Join ZCTA to PPP Data and Checkx
...
**Answer**
# of loans, 41968, Avg Amount 55546.84, median 19949
```{r}
...
**Answer**
Rural
  # = 145, avg = 44815.22, median = 19064.57	
Urban
  # = 41823, avg = 55584.05, median = 19950.00	
```{r}
...
**Answer**
Rural
  # = 18083, avg = 74463.32	, median = 20833	
Urban
  # = 93973, avg = 92029.39	, median = 20833	
```{r}
