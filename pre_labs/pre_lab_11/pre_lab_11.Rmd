...
**Answer**
Information about layer from hospitals, with geometry type point.
```{r}
...
**Answer**
Hospitals in Maryland with a bunch of their information, including points for geometry.
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Shows a lot of information for Maryland general acute care hospitals, including their geometry.
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A grid system that has plotted points for each Maryland hospital
```{r}
md_hospitals %>%
  ggplot() + 
  geom_sf() + 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A lot of information about counties
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Puts hospital points in the Maryland county map
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Same graph as above but now colors the dots for hopsitals based on beds
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Information about maryland general acute care hospitals
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Sorts counties by beds in hospitals
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Dataframe with population and geometry
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Joins population geometry and total beds
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Map that shows with color, beds per 100k per county
```{r}
ggplot() + 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Same map as above with better color scale
```{r}
ggplot() + 
  geom_sf(data=md_beds_per_100k, aes(fill=beds_per_100k)) + 
  theme_minimal() +
...
**Answer**
Same as above but now uses a log scale to show differences better
```{r}
ggplot() + 
  geom_sf(data=md_beds_per_100k, aes(fill=beds_per_100k)) + 
  theme_minimal() +
