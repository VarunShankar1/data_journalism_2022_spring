...
**Answer**
Nevada had most growth at 35.15 percent.
```{r}
...
**Answer**
Howard County, with 121160 median income.
```{r}
...
**Answer**
Caroline and Somerset. Both changes are inside the margin of error.
```{r}
md10 %>%
...
**Answer**
3 had less than 50,000, 21202, 21740, and 21201.
```{r}
